...
import ru.practicum.server.exception.EmptyItemAvailabilityException;
...
public class ControllerTest {
    ...
    void testGetItemById() throws Exception {
        ...
        mvc.perform(get("/items/1")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.lastBooking.id", Matchers.is(itemWithInfo.getLastBooking().getId().intValue())))
                .andExpect(MockMvcResultMatchers.jsonPath("$.lastBooking.bookerId", Matchers.is(itemWithInfo.getLastBooking().getBookerId())))
                .andExpect(MockMvcResultMatchers.jsonPath("$.nextBooking.id", Matchers.is(itemWithInfo.getNextBooking().getId().intValue())))
                .andExpect(MockMvcResultMatchers.jsonPath("$.nextBooking.bookerId", Matchers.is(itemWithInfo.getNextBooking().getBookerId())))
    ...
    void testGetOwnersItems() throws Exception {
        ...
        mvc.perform(get("/items")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].lastBooking.id", Matchers.is(itemWithInfo.getLastBooking().getId().intValue())))
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].lastBooking.bookerId", Matchers.is(itemWithInfo.getLastBooking().getBookerId())))
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].nextBooking.id", Matchers.is(itemWithInfo.getNextBooking().getId().intValue())))
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].nextBooking.bookerId", Matchers.is(itemWithInfo.getNextBooking().getBookerId())))
